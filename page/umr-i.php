        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-8 mb-6 mb-md-0">
              <img src="../assets/img/portfolio/demo-umr-i.jpg" alt="project image">
            </div>


            <div class="col-md-4">
              <h5>Project detail</h5>
               <h3>Universal medical Informatics (IoS)</h3>
...
Give all healthcare providers a unique and clinically focused Dashboard for review of all data generated by its partners.</p>
              <ul class="project-detail mt-7">
                <li>
                  ...
                  <span> USA and Other Countries As Well</span>
                </li>
                ...
                <li>
                  ...
                  <div class="social social-sm social-gray social-inline mt-2">
                    ...
                    <a class="social-dribbler" href="https://merjporosh.blogger.com"><i class="fa fa-blogger"></i></a>
            ...
            <div class="row gap-y gap-2" data-shuffle="list">
			  ...
			  <div class="col-6 col-lg-3" data-shuffle="item" data-groups="umr">
                <a class="portfolio-1" href="umr.php" data-toggle="modal" data-target="#modal-portfolio-umr">
				 ...
				 <div class="col-6 col-lg-3" data-shuffle="item" data-groups="umr">
                <a class="portfolio-1" href="umr-i.php" data-toggle="modal" data-target="#modal-portfolio-umr-i">
